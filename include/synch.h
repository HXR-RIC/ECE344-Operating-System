...
struct lock {
	char *name;
	volatile int held;
	volatile struct thread *curthread_holder;
...
void 		lock_acquire_two_direction(struct lock*, struct lock*);
void 		lock_acquire_three_direction(struct lock*, struct lock*, struct lock*);
void         lock_release(struct lock *);
void 		lock_release_two_direction(struct lock*, struct lock*);
void 		lock_release_three_direction(struct lock*, struct lock*, struct lock*);
