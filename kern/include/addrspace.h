...
#define MID_PAGE_FRAME 0x003ff000
#define First_PAGE_DIRECTORY 0xffc00000
struct vnode;
...
struct page_table { //change the structure 
    paddr_t paddr;
    int valid_bit;
};

struct page_dictionary {
    struct page_table *dictionary_entry;

};

struct core_map {
    struct addrspace* addrspace;
    paddr_t core_map_padd;
    vaddr_t core_map_vadd;
    int npages;
    enum core_map_type state;
};
